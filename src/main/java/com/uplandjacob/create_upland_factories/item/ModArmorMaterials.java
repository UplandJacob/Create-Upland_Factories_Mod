...
public enum ModArmorMaterials implements ArmorMaterial {
    ELECTRIFIED_DIAMOND("el_diamond", 0, new int[]{6, 8, 9, 5}, 20, SoundEvents.ARMOR_EQUIP_DIAMOND, 4.0F, 0.3F, () -> {
        return Ingredient.of(ModItems.ELECTRIFIED_DIAMOND_INGOT.get());
    });
    ...
    public String getName() {
        return UplandFactoriesMod.MOD_ID + ":" + this.name;
    }
